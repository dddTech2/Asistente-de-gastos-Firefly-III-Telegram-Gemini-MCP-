...
| 1.3 | alta-usuario-firefly | Flujo controlado de alta de cuentas Firefly III | in-progress — variante semi-manual implementada (spike 1.2), pendiente de verificación en producción |
